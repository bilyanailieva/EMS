...
CREATE TABLE `customers` (
  ...
  `c_notes` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`c_id`)
...
CREATE TABLE `reservations` (
  ...
  `room_types` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `room_types` VALUES (1,'double'),(2,'single'),(3,'apartment');
...
INSERT INTO `rooms` VALUES (1,'101',1,'90'),(2,'102',1,'90'),(3,'103',1,'90'),(4,'200',2,'85');
...
INSERT INTO `users` VALUES (1,'Test','test@test.com','test'),(3,'Admin','admin@mail.com','123'),(5,'newTest','new@test.com','12345');
...
-- Dump completed on 2021-01-05 21:43:33
